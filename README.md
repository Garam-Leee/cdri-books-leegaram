...
| 라이브러리               | 선택 이유                                                                                                                                 |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| **React**                | 컴포넌트 기반으로 UI를 구성하고 상태를 효율적으로 관리하기 위해 사용했습니다.                                                             |
...
| 접근성 개선       | 검색 기록, 상세 검색 팝업, 찜 버튼 등에 키보드 탐색과 ARIA 속성을 추가하여 접근성을 향상시킬 수 있습니다.                                            |
| 렌더링 최적화     | React DevTools Profiler를 활용하여 병목이 확인되는 컴포넌트를 대상으로 `memo`, `useMemo`, `useCallback`을 적용해 불필요한 렌더링을 줄일 수 있습니다. |
